...
public class SearchWebServiceClient {
	...
	public static void main(final String[] args) throws Exception {
	    ...
	    String xml = searchWebService.search(text, type, constraints, offset, limit, getResults, getFacets, returnType);
	    ...
	    xml = searchWebService.search(text, type, constraints, offset, limit, getResults, getFacets, returnType);
