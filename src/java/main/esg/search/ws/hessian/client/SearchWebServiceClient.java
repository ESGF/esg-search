...
public class SearchWebServiceClient {
	...
	public static void main(final String[] args) throws Exception {
	    ...
	    String xml = searchWebService.search(text, type, constraints, offset, limit, true, returnType);
	    ...
	    type = "Dataset";
	    xml = searchWebService.searchById(id, type, offset, limit, returnType);
	    ...
	    xml = searchWebService.searchByTimeStamp(startTimeStamp, stopTimeStamp, type, offset, limit, returnType);
