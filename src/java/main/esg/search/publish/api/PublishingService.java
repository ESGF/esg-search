 ...
 * 
 * All methods throw RuntimeExceptions, which are correctly
...
public interface PublishingService {
	 ...
	 * @throws Exception
	 */
	void publish(String uri, boolean recursive, MetadataRepositoryType metadataRepositoryType) throws RuntimeException;
	 ...
	 * @throws Exception
	 */
	void unpublish(String uri, boolean recursive, MetadataRepositoryType metadataRepositoryType) throws RuntimeException;
	 ...
	 * @throws Exception
	 */
	void unpublish(List<String> ids) throws RuntimeException;
