...
public class SolrXmlBuilderTest {
	...
	private final static ClassPathResource DELETE_MESSAGE = new ClassPathResource("esg/search/harvest/impl/solr/delete.xml");
	private final static ClassPathResource ADD_MESSAGE = new ClassPathResource("esg/search/harvest/impl/solr/add.xml");
